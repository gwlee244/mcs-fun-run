    ...
    return (
      <main>
        <section className="intro">
            ...
            <div> 
             <p>
             &#8226; To participate, you may contribute a pre-determined amount or get others to sponsor you. <br></br>
             &#8226; Sponsors may make a onetime donation OR may sponsor you based on the number of minutes you exercise (ex. 30 min a day for 5 days = 150 minutes. If someone sponsors you $1/minute that equals $150 for financial aid). <br></br>
             &#8226; Send your friends an email and share this page, suggest they support financial aid by sponsoring you or your team! You could even invite them to join! (They can participate and donate to the event.) <br></br>

             &#8226; <b>Your donation amount is not important, participating and having fun is! Contribute what is comfortable for you.</b> <br></br>
